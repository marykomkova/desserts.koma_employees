...
{
    public partial class ReadyOrderForEmplRowControl : UserControl
    {
        SqlDataAdapter ordersAdapter;
        DataSet ordersDataSet;
        OrdersForEmplControl ordersControl;
        string id;
        public ReadyOrderForEmplRowControl(string i, OrdersForEmplControl cntrl)
        {
            InitializeComponent();
            id = i;
            ordersControl = cntrl;
        ...
        private void ReadyOrderForEmplRowControl_Load(object sender, EventArgs e)
        {
